...
def parse(prog_language, code):
    ...
    return bfs_tree_traverser(tree.root_node, nx.Graph())
    ...
    while queue:
        ...
        for child_node in node.children:
            if child_node not in visited:
                ...
                G.add_node(node_id, type=child_node.type, text=child_node.text, children=child_node.children,
                           parent=child_node.parent, parent_id=parent_id)
